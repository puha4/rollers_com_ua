...
class TmSocialFeeds extends Module
{
	public function __construct()
	{
		...
		parent::__construct();
		$this->displayName = $this->l('TemplateMonster Social Feeds');
	...
	protected function addItem($item_type, $hook, $id_shop, $item_theme, $item_order,
								$item_width, $item_height, $item_limit, $item_header,
								$item_footer, $item_border, $item_replies, $item_scroll,
								$item_background, $item_col_width, $active)
	{
	...
	protected function updateItem($item_type, $hook, $id_shop, $item_theme, $item_order,
									$item_width, $item_height, $item_limit, $item_header,
									$item_footer, $item_border, $item_replies, $item_scroll,
									$item_background, $item_col_width, $active)
	{
	...
	{
		$code = explode('-', $code);
		$code_upper = Tools::strtoupper($code[1]);
		$code = $code[0].'_'.$code_upper;
		return $code;
	}
