	...
	public function initContent()
	{
		...
		if ($g_client->getAccessToken()) 
		{
			...
			if (empty($useremail))
			{
				...
				{
					$this->redirect_uri = $this->context->link->getModuleLink('tmsociallogin', 'googleregistration',
																				array(
																					'user_id' => $user_id,
																					'user_name' => $user_name,
																					'email' => $email,
				...
				{
					$this->redirect_uri = $this->context->link->getModuleLink('tmsociallogin', 'googlelink',
																				array(
																					'user_id' => $user_id,
																					'user_name' => $user_name,
																					'email' => $email,
