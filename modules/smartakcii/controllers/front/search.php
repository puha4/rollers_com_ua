...
class smartakciisearchModuleFrontController extends smartakciiModuleFrontController
{
    public $ssl = true;
    ...
    public function initContent(){
           ...
           parent::initContent();
           $rer  =  SmartAkciiPost::tagsPost('asd');
            ...
            $akciicomment = new Akciicomment();
                ...
                $c = (int)Tools::getValue('page');
                    ...
                    $keyword = Tools::getValue('smartsearch');
                    $id_lang = (int)$this->context->language->id;
                $result = SmartAkciiPost::SmartAkciiSearchPost($keyword,$id_lang,$limit_start,$limit);
                
                $total = SmartAkciiPost::SmartAkciiSearchPostCount($keyword,$id_lang);
