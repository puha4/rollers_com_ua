...
class blocksocial extends Module
{
	...
	public function install()
	{
		return (parent::install() AND Configuration::updateValue('BLOCKSOCIAL_FACEBOOK', '') && 
			...
			Configuration::updateValue('BLOCKSOCIAL_CONTACT', '') &&
	...
	public function uninstall()
	{
		...
		return (Configuration::deleteByName('BLOCKSOCIAL_FACEBOOK') AND 
			...
			Configuration::deleteByName('BLOCKSOCIAL_CONTACT') AND
			parent::uninstall());
	}
	...
	public function getContent()
	{
		...
		{	
			...
			Configuration::updateValue('BLOCKSOCIAL_CONTACT', Tools::getValue('blocksocial_contact', ''));
	...
	public function hookDisplayFooter()
	{
		if (!$this->isCached('blocksocial.tpl', $this->getCacheId()))
			$this->smarty->assign(array(
				...
				'contact_url' => Configuration::get('BLOCKSOCIAL_CONTACT'),
			));
		...
		$fields_form = array(
			'form' => array(
				...
				'input' => array(
					...
					array(						
						'type' => 'text',						
						'label' => $this->l('CONTACT URL:'),						
						'name' => 'blocksocial_contact',						
						'desc' => $this->l('Your contact page.'),					
					),
				),
				'submit' => array(
					'title' => $this->l('Save'),
	...
	public function getConfigFieldsValues()
	{
		return array(
			...
			'blocksocial_contact' => Tools::getValue('blocksocial_contact', Configuration::get('BLOCKSOCIAL_CONTACT')),
		);
	}
