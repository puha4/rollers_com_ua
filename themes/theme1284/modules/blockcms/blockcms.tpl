...
{else}
	...
	<section class="footer-block col-xs-12 col-sm-3" id="block_various_links_footer">
		...
		<ul class="toggle-footer">
			...
			{/if}
			<li>
				<a href="akcii" title="{l s='Akcii' mod='blockcms'}">
					{l s='Акции' mod='blockcms'}
				</a>
			</li>
		</ul>
		{$footer_text}
	...
	<div class="bottom-footer col-xs-12">
		<div>
			&copy; <span class="current-year">{'Y'|date}</span> {l s='[1]Ecommerce software by %s[/1]' mod='blockcms' sprintf=['PrestaShop™']}
		</div>
	</div>
	{/if}
	<!-- /Block CMS module footer -->
