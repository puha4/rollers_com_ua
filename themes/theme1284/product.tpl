	...
	<div class="primary_block row">		
		...
		{/if}
                ...
                <div class="pb-right-column {if $columns == 2}col-xs-12 col-md-5 col-lg-6{elseif $columns == 3}col-xs-12 {elseif $content_only} col-xs-6{else}col-sm-6 col-md-6 col-lg-4{/if}">
                    ...
                    <h1 itemprop="name">
                        {if $product->h1_name}
                            {$product->h1_name|escape:'html':'UTF-8'}
                        {else}
                                    ...
                                    <div class="old-price-info">
                                       <p id="old_price"{if (!$product->specificPrice || !$product->specificPrice.reduction)} class="hidden"{/if}>{strip}
                                            {if $priceDisplay >= 0 && $priceDisplay <= 2}
                                                	...
                                                	<span id="old_price_display"><span class="price">{if $productPriceWithoutReduction > $productPrice}{convertPrice price=$productPriceWithoutReduction|floatval}{/if}</span>
